...
namespace PH1
{
    public partial class fUpdateNhanvien : Form
    {
        ...
        private void update_btn_Click(object sender, EventArgs e)
        {
            ...
            if (ndiachi == "")
            {
                MessageBox.Show("Please fill the address!", "Message", MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }
            string nsodt = textBox_Sodt.Text.Trim().ToString();
            if (nsodt == "")
            {
                MessageBox.Show("Please fill the phone number!", "Message", MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }
            ...
            if (!isMatch)
            {
                MessageBox.Show("The phone number is invalid!", "Message", MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }
            ...
            try
            {
                ...
                MessageBox.Show("Personal information was updated successfully!", "Message", MessageBoxButtons.OK, MessageBoxIcon.Information);

                this.Hide();
            }
            catch
            {
                MessageBox.Show("Updating information fail!", "Message", MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }
        }
    }
