    ...
    public partial class fUpdateDA : Form
    {
        ...
        private void button_Capnhat_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                MessageBox.Show("The project information was updated successfully !", "Massage", MessageBoxButtons.OK, MessageBoxIcon.Information);

                this.Hide();
            }
            catch
            {
                MessageBox.Show("Updating project information fail!", "Massage", MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }
        }
