...
GRANT SELECT ON dba_sys_privs TO U_AD WITH GRANT OPTION;
GRANT SELECT ON role_sys_privs TO U_AD WITH GRANT OPTION;
GRANT SELECT ON DBA_COL_PRIVS TO U_AD WITH GRANT OPTION;
GRANT SELECT ON DBA_ROLE_PRIVS to U_AD WITH GRANT OPTION;
