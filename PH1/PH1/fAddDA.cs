...
namespace PH1
{
    public partial class fAddDA : Form
    {
        ...
        private void button_Them_Click(object sender, EventArgs e)
        {
            ...
            if (mada == "")
            {
                MessageBox.Show("Please fill the project ID!", "Massage", MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }
            string tenda = textBox_TenDA.Text.Trim().ToString();
            if (tenda == "")
            {
                MessageBox.Show("Please fill the project name!", "Massage", MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }
            ...
            try
            {
                ...
                MessageBox.Show("The new project was added successfully!", "Massage", MessageBoxButtons.OK, MessageBoxIcon.Information);

                this.Hide();
            }
            catch
            {
                MessageBox.Show("Adding project fail!", "Massage", MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }
        }
    }
